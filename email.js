...
let host = "http://werthere4u.in/";

exports.sendVerificationMail = function (email, token, r, user_type) {
  let content = "<b>Welcome " + email + " !!!</b>" +
    "<p>Please <a target='_blank' href='" + host + "verifyUser?t=" + token + "&r=" + r + "'> <b>Click here </b></a> to verify your account.</p>"
...
exports.resetPasswordLink = function (email, r) {
  let content = "<b>Hello " + email + " !!!</b>" +
    "<p>Please <a target='_blank' href='" + host + "resetPassword?e=" + email + "&r=" + r + "'> <b>Click here </b></a> to reset your password.</p>"
  let transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
